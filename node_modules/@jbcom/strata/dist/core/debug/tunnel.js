 ...
 * ```
 */
export const DebugOverlayTunnel = createTunnel();
/**
 ...
 * ```
 */
export const FPSCounterTunnel = createTunnel();
/**
 ...
 * ```
 */
export const StatsPanelTunnel = createTunnel();
/**
 ...
 * ```
 */
export function getDebugTunnel(id) {
    switch (id) {
        case 'debug-overlay':
