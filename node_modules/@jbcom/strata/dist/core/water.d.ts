 ...
 */
export declare function createWaterMaterial(options?: WaterMaterialOptions): THREE.ShaderMaterial;
/**
 * Create advanced water material (pure TypeScript)
 */
export declare function createAdvancedWaterMaterial(options?: AdvancedWaterMaterialOptions): THREE.ShaderMaterial;
/**
 * Create water geometry (pure TypeScript)
 */
export declare function createWaterGeometry(size: number, segments?: number): THREE.PlaneGeometry;
