...
`;
export function createVolumetricFogMeshUniforms(color, density, height, cameraPosition) {
    return {
        uTime: { value: 0 },
...
export function createUnderwaterOverlayUniforms(waterColor, density, causticStrength, waterSurface, cameraY) {
    return {
        uTime: { value: 0 },
...
//# sourceMappingURL=volumetrics-components.js.map