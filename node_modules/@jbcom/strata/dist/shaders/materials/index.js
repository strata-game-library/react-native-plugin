...
export function createToonMaterial(options = {}) {
    const { color = 0xffffff, outlineColor = 0x000000, outlineWidth = 0.0, levels = 4, rimColor = 0x4488ff, rimPower = 2.0, } = options;
...
export function createHologramMaterial(options = {}) {
    const { color = 0x00ffff, scanlineIntensity = 0.5, scanlineDensity = 100, flickerSpeed = 1.0, fresnelPower = 2.0, alpha = 0.8, } = options;
    return new THREE.ShaderMaterial({
        uniforms: {
            uTime: { value: 0 },
            uColor: { value: new THREE.Color(color) },
...
export function createDissolveMaterial(options = {}) {
    const { color = 0xffffff, edgeColor = 0xff6600, progress = 0, edgeWidth = 0.05, noiseScale = 3.0, } = options;
    return new THREE.ShaderMaterial({
        uniforms: {
            uColor: { value: new THREE.Color(color) },
...
export function createForcefieldMaterial(options = {}) {
    const { color = 0x00ffff, secondaryColor = 0x0088ff, fresnelPower = 3.0, pulseSpeed = 1.0, hexagonScale = 10.0, alpha = 0.6, } = options;
    return new THREE.ShaderMaterial({
        uniforms: {
            uTime: { value: 0 },
            uColor: { value: new THREE.Color(color) },
...
export function createGlitchMaterial(options = {}) {
    const { color = 0xffffff, glitchIntensity = 0.1, scanlineIntensity = 0.3, rgbShiftAmount = 0.01, } = options;
    return new THREE.ShaderMaterial({
        uniforms: {
            uTime: { value: 0 },
            uColor: { value: new THREE.Color(color) },
...
export function createCrystalMaterial(options = {}) {
    const { color = 0xffffff, refractionRatio = 0.98, fresnelPower = 4.0, rainbowIntensity = 0.3, envMapIntensity = 1.0, } = options;
    return new THREE.ShaderMaterial({
        uniforms: {
            uTime: { value: 0 },
            uColor: { value: new THREE.Color(color) },
...
export function createGradientMaterial(options = {}) {
    const { colorStart = 0xff0000, colorEnd = 0x0000ff, colorMiddle = 0x00ff00, direction = 'vertical', useThreeColors = false, } = options;
...
export function createScanlineMaterial(options = {}) {
    const { color = 0x00ff00, backgroundColor = 0x001100, scanlineDensity = 400, scanlineOpacity = 0.3, flickerIntensity = 0.03, curvature = 0.1, } = options;
    return new THREE.ShaderMaterial({
        uniforms: {
            uTime: { value: 0 },
            uColor: { value: new THREE.Color(color) },
