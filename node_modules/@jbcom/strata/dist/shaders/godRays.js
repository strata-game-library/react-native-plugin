...
`;
export function createGodRaysUniforms(lightPosition, lightColor, options = {}) {
    return {
        uTime: { value: 0 },
...
export function createVolumetricSpotlightUniforms(lightPosition, lightDirection, lightColor, options = {}) {
    return {
        uTime: { value: 0 },
        uLightColor: { value: lightColor.clone() },
        uIntensity: { value: options.intensity ?? 1.0 },
...
export function createVolumetricPointLightUniforms(lightPosition, lightColor, options = {}) {
    return {
        uTime: { value: 0 },
        uLightColor: { value: lightColor.clone() },
        uIntensity: { value: options.intensity ?? 1.0 },
